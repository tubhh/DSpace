...
<dspace:layout titlekey="jsp.mydspace" nocache="true">
    ...
    {
        %>
        <h2><fmt:message key="jsp.mydspace.myprofile"/></h2>
        <span id="h2-cris-rp-status" class="cris-rp-status">
        	<!-- <fmt:message key="jsp.layout.hku.detail.title-first"/> 
        	<span class="cris-rp-status-value"><fmt:message key="jsp.mydspace.cris.rp-status-loading"/></span><br/>-->
        	<a href="#"><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/> <span class="fa fa-edit"></span></a>
        </span>
        <span id="h2-cris-rp-status-active" class="cris-rp-status" style="display:none;">
        	<!-- <fmt:message key="jsp.layout.hku.detail.title-first"/> 
        	<span class="cris-rp-status-value"><fmt:message key="jsp.mydspace.cris.rp-status-active"/></span><br/> -->
        	<a href="#" class="cris-rp-status-active" data-toggle="modal" data-target="#cris-rp-change-active"><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/> <span class="fa fa-edit"></span></a>
        </span>
	<span id="h2-cris-rp-status-active-admin" class="cris-rp-status" style="display:none;">
        	<!--<fmt:message key="jsp.layout.hku.detail.title-first"/> 
        	<span class="cris-rp-status-value"><fmt:message key="jsp.mydspace.cris.rp-status-active"/></span><br/>-->
        	<a href="#" class="cris-rp-status-active" data-toggle="modal" data-target="#cris-rp-change-admin"><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/> <span class="fa fa-edit"></span></a>
        </span>
        <span id="h2-cris-rp-status-inactive" class="cris-rp-status" style="display:none;">
        	<!--<fmt:message key="jsp.layout.hku.detail.title-first"/> 
        	<span class="cris-rp-status-value"><fmt:message key="jsp.mydspace.cris.rp-status-inactive"/></span><br/>-->
        	<a href="#" class="cris-rp-status-inactive" data-toggle="modal" data-target="#cris-rp-change-inactive"><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/> <span class="fa fa-edit"></span></a>
        </span>
	<span id="h2-cris-rp-status-inactive-admin" class="cris-rp-status" style="display:none;">
        	<!--<fmt:message key="jsp.layout.hku.detail.title-first"/> 
        	<span class="cris-rp-status-value"><fmt:message key="jsp.mydspace.cris.rp-status-inactive"/></span><br/>-->
                <a href="#" class="cris-rp-status-inactive" data-toggle="modal" data-target="#cris-rp-change-admin"><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/> <span class="fa fa-edit"></span></a>
        </span>
...
%>
        <h2><fmt:message key="jsp.mydspace.mypublications"/></h2>
...
%>
    ...
    <table class="table" align="center" summary="Table listing owned tasks">
        <tr>
            ...
            <th id="t101" class="oddRowEvenCol"><fmt:message key="jsp.mydspace.main.doctype"/></th>
            <th id="t4" class="oddRowOddCol"><fmt:message key="jsp.mydspace.main.subby"/></th>
...
<%
        ...
        for (int i = 0; i < owned.length; i++)
        {
            ...
            Metadatum[] typeArray =
                owned[i].getItem().getDC("type", null, Item.ANY);
...
%>
                ...
                <td headers="t101" class="<%= row %>RowEvenCol"><%= Utils.addEntities(type) %></td>
                <td headers="t4" class="<%= row %>RowOddCol"><a href="mailto:<%= submitter.getEmail() %>"><%= Utils.addEntities(submitter.getFullName()) %></a></td>
...
%>
    ...
    <table class="table" align="center" summary="Table listing the tasks in the pool">
        <tr>
            ...
            <th id="t101" class="oddRowEvenCol"><fmt:message key="jsp.mydspace.main.doctype"/></th>
            <th id="t9" class="oddRowOddCol"><fmt:message key="jsp.mydspace.main.subby"/></th>
...
<%
        ...
        for (int i = 0; i < pooled.length; i++)
        {
            ...
            String title = (titleArray.length > 0 ? titleArray[0].value
                    : LocaleSupport.getLocalizedMessage(pageContext,"jsp.general.untitled") );
            Metadatum[] typeArray =
                pooled[i].getItem().getDC("type", null, Item.ANY);
            String type = (typeArray.length > 0 ? typeArray[0].value
                    : LocaleSupport.getLocalizedMessage(pageContext,"jsp.general.untitled") );
...
<div id="private-entities">
	...
	<script>
		...
		<div class="modal fade" id="cris-rp-change-active" tabindex="-1" role="dialog" aria-labelledby="<fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/>" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							<h4 class="modal-title"><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/></h4>
						</div>
						...
						<div class="btn-group btn-group-sm" role="group">
							 ...
							 <button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message key="jsp.mydspace.general.cancel"/></button>
						</div>
						</div>
					</div>
					<!-- /.modal-content -->
		...
		<div class="modal fade" id="cris-rp-change-inactive" tabindex="-1" role="dialog" aria-labelledby="<fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/>" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
	    ...
	    <div class="modal fade" id="cris-rp-change-undefined" tabindex="-1" role="dialog" aria-labelledby="<fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/>" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		...
		<div class="modal fade" id="cris-rp-change-admin" tabindex="-1" role="dialog" aria-labelledby="<fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.title"/>" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						...
						<div class="modal-body with-padding">
							<p><fmt:message key="jsp.mydspace.cris.rp-status-change.dialog.text"/></p>
						</div>
						<div class="modal-footer">
							 <a href="#" class="btn btn-info myrpstatus-url"><fmt:message key="jsp.mydspace.cris.rp-status-change.go"/></a>
							 <button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message key="jsp.mydspace.general.cancel"/></button>
