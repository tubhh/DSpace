...
<c:choose>
    <c:when test="${!empty anagraficaObject.anagrafica4view['system-orcid-token-authenticate']}">
        <span style="min-width: 30em;"><a target="_blank" href="https://orcid.org/${anagraficaObject.anagrafica4view['orcid'][0]}"><img src="/image/orcid_16x16.png" /> orcid.org/${anagraficaObject.anagrafica4view['orcid'][0]}</a></span>
    </c:when>
    <c:otherwise>
        <c:choose>
