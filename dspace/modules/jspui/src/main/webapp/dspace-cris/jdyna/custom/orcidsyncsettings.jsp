		...
		<div id="collapseOne${holder.shortName}" class="panel-collapse collapse in">
			...
			<div class="dynaField"></div>								
                            <c:choose>
                                            ...
                                            <c:otherwise>
                                        <br/><a class="btn btn-default" href="<%= request.getContextPath() %>/cris/tools/rp/editDynamicData.htm?id=${researcher.id}&tabId=17"><fmt:message key="jsp.orcid.custom.pushlink"/></a><br/><br/>
<%--
                                        <c:choose>
