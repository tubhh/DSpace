		...
		<fieldset><legend><fmt:message
			...
			<c:if test="${!empty box.id}">			
				...
				key="jsp.dspace-admin.hku.jdyna-configuration.deletedynamicfield" />"
						href="<%=request.getContextPath()%>/cris/administrator/${specificPartPath}/deleteFieldDefinition.htm?pDId=${boxed.real.id}&boxId=${box.id}&tabId=${tabId}" onClick="javascript:return confirm('Do you really want to delete this field?');">
