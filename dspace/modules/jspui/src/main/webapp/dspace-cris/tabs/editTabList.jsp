		...
		<c:forEach items="${listTab}" var="tab">
			...
			${tab.title} <c:if
				...
				key="jsp.dspace-admin.hku.jdyna-configuration.deletedynamicfield" />"
					href="<%=request.getContextPath()%>/cris/administrator/${specificPartPath}/deleteEditTabs.htm?id=${tab.id}" onClick="javascript:return confirm('Do you really want to delete this tab?');">
