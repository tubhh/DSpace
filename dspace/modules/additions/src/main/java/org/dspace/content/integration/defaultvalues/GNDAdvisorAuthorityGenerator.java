...
public class GNDAdvisorAuthorityGenerator implements EnhancedValuesGenerator
{
            ...
            String element, String qualifier, String value)
    {
        ...
        Metadatum[] m = item.getMetadata("dc", "contributor", "advisor", Item.ANY);
        int num = m.length;
...
log.debug("Found GND ID "+gndid+" for advisor "+m[idx].value);
