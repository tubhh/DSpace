 ...
 * 
 */
public class VirtualFieldSchemaOrgCreator
        implements VirtualFieldDisseminator, VirtualFieldIngester
{
            ...
            String fieldName)
    {
        ...
        try
        {
            ...
            mmp.put("@type", "Person");
            mmp.put("name", eperson.getFullName());
            mmp.put("givenName", eperson.getFirstName());
            mmp.put("familyName", eperson.getLastName());

            Gson gson = new GsonBuilder().create();
            String result = gson.toJson(mmp);
            fieldCache.put("virtual.creatorschemaorg", result);
