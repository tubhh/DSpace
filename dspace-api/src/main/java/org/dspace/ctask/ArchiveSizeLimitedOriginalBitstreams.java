 ...
 */
@Distributive
public class ArchiveSizeLimitedOriginalBitstreams extends AbstractCurationTask {
    ...
    protected void performItem(Item item) throws SQLException, IOException {
        ...
        try {
            ...
            String sizeLimit = ConfigurationManager.getProperty("bagit.sizeLimit");
            long calculatedSize = calcSize(originalBitstreams);
            if (calculatedSize > Long.valueOf(sizeLimit)) {
                String mes = "Zip archive would be "+calculatedSize+" Byte and thus would be too large! Won't build Bagit archive for it!";
                errors.add(mes);
                //report(mes);
                //setResult(mes);
                return;
    ...
    private long calcSize(List<Bitstream> bitstreamList) {
        long size = 0;
