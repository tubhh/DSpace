...
public class ADSService
{
	...
	private static final String RESULT_FIELD_LIST="abstract,ack,aff,alternate_bibcode,alternate_title,arxiv_class,author,bibcode,bibgroup,bibstem,citation_count,copyright,database,"
			+ "doi,doctype,first_author,grant,id,indexstamp,issue,keyword,lang,orcid_pub,orcid_user,orcid_other,page,property,pub,pubdate,read_count,title,vizier,volume,year";
        ...
        if (!ConfigurationManager.getBooleanProperty(SubmissionLookupService.CFG_MODULE, "remoteservice.demo"))
        {
            ...
            try
            {
                ...
                uriBuilder.addParameter("fl", RESULT_FIELD_LIST);
	                ...
	                QueryResponse res =  (QueryResponse) SolrResponse.deserialize(bytes);
	                */
